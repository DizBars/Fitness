...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _slider.jurySlider)();
    (0, _slider.reviewsSlider)();
    (0, _subscription.openSubType)();
    (0, _videoplayer.embedVideo)();
  });
});
...
},{"./modules/accordion/accordions":2,"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/scroll":11,"./modules/slider/slider":12,"./modules/subscription":13,"./modules/tabs/init-tabs":14,"./modules/tabs/tabs":15,"./modules/videoplayer":16,"./utils/ios-vh-fix":18}],2:[function(require,module,exports){
"use strict";
...
var scrollButton = document.querySelector('[data-scroll]');
var scrollTarget = document.querySelector('[data-subscription]');
...
exports.jurySlider = jurySlider;
exports.reviewsSlider = reviewsSlider;
require("../../vendor");
var jury = document.querySelector('.swiper__jury');
var reviews = document.querySelector('.swiper__reviews');
function jurySlider() {
  if (jury) {
    var swiper = new Swiper(jury, {
...
},{"../../vendor":19}],13:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.openSubType = openSubType;
var subButtons = document.querySelectorAll('[data-subscription-control]');
var subCards = document.querySelectorAll('[data-subscription-element]');
function openSubType() {
  if (subButtons || subCards) {
    subButtons.forEach(function (button) {
      button.addEventListener('click', function (evt) {
        evt.preventDefault();
        var id = evt.target.getAttribute('data-index-sub');
        subButtons.forEach(function (card) {
...
exports.embedVideo = void 0;
var container = document.querySelector('[data-video="container"]');
var cover = document.querySelector('[data-video="overlay"]').querySelector('picture');
var buttonPlay = document.querySelector('[data-video="play-button"]');
...
var embedVideo = exports.embedVideo = function embedVideo() {
